...
if int(value/50) >= 1:
 ...
 value =value - cinquenta*50;

value = float("%.2f" % value)
if int(value/20) >= 1:
 vinte = int(value/20.00);
 value =value- vinte*20;

value = float("%.2f" % value)
if int(value/10) >= 1:
 dez = int(value/10);
 value =value- dez*10.00;
...
if int(value/0.50) >= 1:
 ...
 value =value- cincents*0.50;

value = float("%.2f" % value)
if int(value/0.25) >= 1:
 vintecincents = int(value/0.25);
 value = value- vintecincents*0.25;

value = float("%.2f" % value)
if int(value/0.10) >= 1:
 dezcents = int(value/0.10);
 value =value- dezcents*0.10;

value = float("%.2f" % value)
if int(value/0.05) >= 1:
 cincocents = int(value/0.05);
 value =value- cincocents*0.05;
 
value = float("%.2f" % value)
if int(value/0.01) >= 0.998:
 cents = int(value/0.01);
 value =value- cents*0.01;
